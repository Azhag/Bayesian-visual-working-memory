...
def sample(N, x_initial, loglike_fct, burn=100, widths=1., last_loglikehood=None, loglike_fct_params=None, step_out=True):
...
def sample_1D(N, x_initial, loglike_fct, burn=100, widths=1., last_loglikehood=None, loglike_fct_params=None, step_out = True, bounds=(-np.inf, np.inf), thinning=1, debug=False):
...
def sample_1D_circular(N, x_initial, loglike_fct, burn=100, widths=1., last_loglikehood=None, loglike_fct_params=None, step_out = True, thinning=1, debug=False, loglike_min=-np.inf, jump=True, jump_probability=0.1):
...
def test_sample():
    ...
    # Get samples
    samples, last_llh = sample_1D_circular(5000, np.random.rand(), loglike_theta_fct, burn=500, widths=np.pi/2., thinning=1, loglike_fct_params=loglike_fct_params, step_out=True, debug=False)
...
if __name__ == '__main__':
    ...
    if False:
        ...
        # Get samples
        samples, last_llh = sample_1D(50000, np.random.rand(), loglike_fct, burn=100, widths=0.2, loglike_fct_params=loglike_fct_params, step_out=True)
    ...
    if True:
        ...
        # Get samples
        samples2, last_llh = sample_1D_circular(5000, np.random.rand(), loglike_theta_fct, burn=500, widths=0.01, loglike_fct_params=loglike_fct_params, step_out=True, debug=True, loglike_min = -np.log((2./2.0)*np.pi*scsp.i0(loglike_fct_params[1])))
        # samples2, last_llh = sample_1D_circular(50000, np.random.rand(), loglike_theta_fct, burn=500, widths=0.01, loglike_fct_params=loglike_fct_params, step_out=True, debug=True)
        # samples2, last_llh = sample_1D_circular(5000, np.random.rand()*2.*np.pi-np.pi, loglike_theta_fct, burn=100, widths=np.pi/5., loglike_fct_params=loglike_fct_params, step_out=True, debug=True)
