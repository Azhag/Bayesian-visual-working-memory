...
run_label = 'cmaes_subjects_bays09_emfitscaled_4try_Mratiosigmaxsigmabaselinelapserate_subject{experiment_subject}rep{num_repetitions}_181018'
...
pbs_submission_infos = dict(
    description=
    '''Fit experiments (bays09), using dist_emfit_scaled ResultComputation), using the CMA-ES code.
    ...
    other_options=dict(
        ...
        bic_K=5,
        ratio_conj=0.5,
        session_id='cmaes_4try_Mratiosigmaxlapsesigmabase_bays09_sub%d' %
        experiment_subject,
    ...
    submit_label='sub%d_4try_b09' % experiment_subject,
    resource=resource,
    partition=partition,
    qos='auto')
