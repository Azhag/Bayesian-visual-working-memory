...
# Vary me between 1-8 for gorgo11
experiment_subject = 1

run_label = 'cmaes_subjects_gorgo11_emfitscaled_5try_Mratiosigmaxsigmabaselinelapserate_subject{experiment_subject}rep{num_repetitions}_181018'
...
pbs_submission_infos = dict(
    description=
    '''Fit experiments (gorgo11), using dist_emfit_scaled ResultComputation), using the CMA-ES code.
    ...
    other_options=dict(
        ...
        bic_K=5,
        ratio_conj=0.5,
        session_id='cmaes_5try_Mratiosigmaxlapsesigmabase_gorgo11_sub%d' %
        experiment_subject,
    ...
    submit_label='sub%d_5try_g11' % experiment_subject,
    resource=resource,
    partition=partition,
    qos='auto')
