...
# run_label = 'outputnoise_cmaes_distemmixtKL_gorgo11_noiseconv_mixed_ratiosigmaxsigmaoutput_allT_M{M}_repetitions{num_repetitions}_110414'
run_label = 'outputnoise_cmaes_distemmixtKL_gorgo11_noiseconv_mixed_ratiosigmaxsigmaoutput_allT_M{M}_repetitions{num_repetitions}_130414'
simul_out_dir = os.path.join(os.getcwd(), run_label.format(**locals()))

parameter_generation = 'cma-es'
cma_population_size = 25
cma_sigma0 = 1.0
