...
run_label = 'outputnoise_cmaes_distfit_gorgo11_ll90_mixed_ratiosigmaxsigmaoutput_allT_M{M}_repetitions{num_repetitions}_280314'
...
pbs_submission_infos = dict(description='Fit experiments (gorgo11), using distfit_gorgo11_ll90 ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes ratio_conj, sigmax and sigma_output. Only looks at LL score, top 90% items.',
                            ...
                            other_options=dict(action_to_do='launcher_do_fitexperiment_allT',
                                               ...
                                               result_computation='distfit_gorgo11_ll90',
                                               M=M,
                                               sigmax=0.1,
                                               N=200,
                                               T=T,
