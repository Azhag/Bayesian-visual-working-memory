...
run_label = 'outputnoise_cmaes_distfit_gorgo11_ll90_mixed_ratiosigmaxsigmaoutput_allT_M{M}_repetitions{num_repetitions}_020414'
...
pbs_submission_infos = dict(description='Fit experiments (gorgo11), using distfit_gorgo11_ll90 ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes ratio_conj, sigmax and sigma_output. Look at bic',
                            ...
                            other_options=dict(action_to_do='launcher_do_fitexperiment_allT',
                                               ...
                                               result_computation='distfit_noiseconv_gorgo11_bic',
                                               M=M,
                                               sigmax=0.1,
                                               N=200,
                                               T=T,
...
sigmaoutput_range =   dict(low=0.0, high=2.0, dtype=float)
