...
run_label = 'outputnoise_random_fitmixturemodels_sigmaxratiosigmaoutput_bis_M{M}_repetitions{num_repetitions}_100414'
...
sigmaoutput_range =   dict(sampling_type='uniform', low=0.0, high=0.5, dtype=float)
