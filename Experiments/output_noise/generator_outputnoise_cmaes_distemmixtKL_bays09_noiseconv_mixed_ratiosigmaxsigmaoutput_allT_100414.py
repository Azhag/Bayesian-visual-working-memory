...
# run_label = 'outputnoise_cmaes_distemmixtKL_bays09_noiseconv_mixed_ratiosigmaxsigmaoutput_allT_M{M}_repetitions{num_repetitions}_100414'
run_label = 'outputnoise_cmaes_distemmixtKL_bays09_noiseconv_mixed_ratiosigmaxsigmaoutput_allT_M{M}_repetitions{num_repetitions}_170414'
...
pbs_submission_infos = dict(description='Fit experiments (bays09), using distemmixtKL_bays09 ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes ratio_conj, sigmax and sigma_output. Get samples and look at the mixture proportions here',
                            ...
                            other_options=dict(action_to_do='launcher_do_fit_mixturemodels',
                                               ...
                                               result_computation='distemmixtKL_bays09',
                                               M=M,
                                               sigmax=0.1,
                                               N=200,
                                               T=T,
