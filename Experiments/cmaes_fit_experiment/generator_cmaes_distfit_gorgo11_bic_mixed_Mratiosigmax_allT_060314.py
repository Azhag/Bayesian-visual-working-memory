...
run_label = 'cmaes_distfit_gorgo11_bic_mixed_Mratiosigmax_allT_repetitions{num_repetitions}_060314'
...
pbs_submission_infos = dict(description='Fit experiments (gorgo11), using distfit_gorgo11_bic ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes M, ratio_conj and sigmax. Only looks at BIC score.',
