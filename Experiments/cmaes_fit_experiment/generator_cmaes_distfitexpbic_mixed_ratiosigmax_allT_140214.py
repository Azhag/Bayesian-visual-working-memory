...
run_label = 'cmaes_distfitexpbic_mixed_ratiosigmax_allT_repetitions{num_repetitions}_140214'
...
pbs_submission_infos = dict(description='Fit experiments (bays09, gorgo11, dualrecall), using distfitexpbic ResultComputation), using the CMA-ES code. Looks at all t<=T here. Only looks at BIC score.',
