...
run_label = 'cmaes_distfit_bays09_bic_mixed_Mratiosigmax_allT_repetitions{num_repetitions}_060314'
...
pbs_submission_infos = dict(description='Fit experiments (bays09), using distfit_bays09_bic ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes M, ratio_conj, sigmax and sigmay. Only looks at BIC score.',
