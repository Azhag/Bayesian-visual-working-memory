...
run_label = 'cmaes_distemmixtKL_gorgo11_mixed_Mratiosigmax_allT_repetitions{num_repetitions}_250414'
...
pbs_submission_infos = dict(description='Fit experiments (gorgo11), using distemmixtKL_gorgo11 ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes M, ratio_conj, sigmax. Get samples and look at the mixture proportions here',
