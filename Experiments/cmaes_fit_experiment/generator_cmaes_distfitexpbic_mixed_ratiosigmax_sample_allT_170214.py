...
run_label = 'cmaes_distfitexpbic_mixed_ratiosigmax_sample_allT_repetitions{num_repetitions}_170214'
...
pbs_submission_infos = dict(description='Fit experiments (bays09, gorgo11, dualrecall), using distfitexpbic ResultComputation), using the CMA-ES code. Looks at all t<=T here. Optimize based on BIC only, but does sample and fit the mixture model as well.',
