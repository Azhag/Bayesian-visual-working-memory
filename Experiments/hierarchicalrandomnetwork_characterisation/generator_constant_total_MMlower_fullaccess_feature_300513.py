...
if v2:
    ...
    run_label = 'hierarchical_constant_total_smaller_MMlower_fullaccess_volume_featurelayer_300513'

if other_threshold:
    # Use the optimal threshold instead
    threshold = 1.0
    run_label = 'hierarchical_constant_total_MMlower_fullaccess_volume_featurelayer_threshopt_010613'
else:
    threshold = 0.0
