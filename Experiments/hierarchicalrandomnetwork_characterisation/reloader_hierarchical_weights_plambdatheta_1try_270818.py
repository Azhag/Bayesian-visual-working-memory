...
dataset_infos = dict(
    label=
    "Random sweeps for Thesis, chapter about Single item characterisation. HIERARCHICAL CODE. Varying parameters controlling the weights and threshold of neurons.",
    files="%s/%s*.npy" %
    ...
    # limit_max_files=1,
    parameters=['threshold', 'sigma_weights', 'sparsity'],
    variables_to_load=[
