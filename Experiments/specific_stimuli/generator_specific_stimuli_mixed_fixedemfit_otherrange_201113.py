...
sigmax_range          =   dict(range=np.linspace(0.01, 0.5, 25.)[7:-10], dtype=float)
min_distance_range    =   dict(range=np.linspace(0.01, np.pi/2., 23.)[:4], dtype=float)
