...
run_label = 'error_distribution_hierarchical_ratio{ratio_conj}M{M}T{T}repetitions{num_repetitions}mult_121113'
...
sigmax_range =    dict(range=np.linspace(0.4, 0.7, 16.), dtype=float)
