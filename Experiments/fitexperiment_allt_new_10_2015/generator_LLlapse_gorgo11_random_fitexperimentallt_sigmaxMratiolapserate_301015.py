...
run_label = 'LLlapse_random_fitexperimentallt_{experiment_id}_sigmaxMratiolapserate_repetitions{num_repetitions}_301015'
...
ratioconj_range   =   dict(sampling_type='uniform', low=0.4, high=1.0, dtype=float)
lapserate_range   =   dict(sampling_type='uniform', low=0.0, high=0.2, dtype=float)
