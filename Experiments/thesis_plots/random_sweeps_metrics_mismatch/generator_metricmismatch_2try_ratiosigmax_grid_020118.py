...
run_label = 'metricmismatch_ratiosigmax_grid_2try_repetitions{num_repetitions}_130118'
sleeping_period = dict(min=1, max=5)

pbs_submission_infos = dict(
    description=
    '''Runs the model for 1..T items. Computes precision, Fisher information, fits the mixture model, and compare the mixture model fits to the experimental data (Bays09 and Gorgo11 here). Also stores all responses. Meant to run random sampling for a long while!

    2try, to check the Scaled MSE EM fit too.
    ''',
