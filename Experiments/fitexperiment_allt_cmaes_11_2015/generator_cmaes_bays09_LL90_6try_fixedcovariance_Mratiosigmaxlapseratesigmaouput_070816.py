...
run_label = 'cmaes_bays09_ll90_6try_fixedcovariance_Mratiosigmaxlapseratesigmaout_repetitions{num_repetitions}_070816'
...
pbs_submission_infos = dict(description='Fit experiments (bays09), using dist_ll90_allt ResultComputation), using the CMA-ES code. Looks at all t<=T here. Changes M, ratio_conj, sigmax, lapse rate, sigma output. Only looks at LL score, top 90 percent. Looking for best meaningful parameter bounds now. Using new fixed Covariance matrix for Sampler, should change N=1 case most.',
                            ...
                            other_options=dict(action_to_do='launcher_do_fitexperiment_allmetrics',
                                               ...
                                               bic_K=5,
                                               ratio_conj=0.5,
                                               session_id='cmaes_6try_Mratiosigmaxlapsesigmaout_bays09',
...
sigmaoutput_range =   dict(sampling_type='uniform', low=0.01, high=0.4, dtype=float)
        ...
        if parameters.get('submit_best', False):
            ...
            try:
                ...
                pbs_submission_infos_copy['other_options'].update(dict(
                    ...
                    stimuli_generation='random',
                    stimuli_generation_recall='random',
                    session_id='cmaes_bays09_6try_rerun_070816',
                    result_computation='filenameoutput',
                    label='%s_cmaes_bays09_6try_070816' % (curr_params_label)
                ))
