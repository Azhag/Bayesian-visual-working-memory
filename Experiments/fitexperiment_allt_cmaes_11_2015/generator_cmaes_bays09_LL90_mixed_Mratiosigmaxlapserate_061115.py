...
run_label = 'cmaes_bays09_ll90_mixed_Mratiosigmaxlapserate_repetitions{num_repetitions}_061115'
...
M_range           =   dict(sampling_type='randint', low=6, high=500, dtype=int)
