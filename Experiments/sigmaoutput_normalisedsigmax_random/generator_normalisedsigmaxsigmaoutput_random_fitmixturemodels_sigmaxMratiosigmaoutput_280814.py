...
run_label = 'normalisedsigmaxsigmaoutput_random_fitmixturemodels_sigmaxMratiosigmaoutput_repetitions{num_repetitions}_280814'

pbs_submission_infos = dict(description='Runs the model for 1..T items. Computes precision, Fisher information, fits the mixture model, and compare the mixture model fits to the experimental data (Bays09 and Gorgo11 here). Also stores all responses. Meant to run random sampling for a long while! Uses the new output noise process, varying sigma_output accordingly. Also use the new normalised sigma_x, which should behave better.',
