...
run_label = 'highdimensional_mixed_papercomments_cuedtype{cued_feature_type}T{T}repetitions{num_repetitions}_120714'

pbs_submission_infos = dict(description='Runs and collect precision, mixture model fits and fisher info for varying M, ratio_conj and R. Should then look at how R affects the precision and the ratio.',
...
R_range      =   dict(range=np.arange(5, 10), dtype=int)
