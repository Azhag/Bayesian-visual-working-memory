...
run_label = 'cmaes_hier_gorgo11_3try_llmedian_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_241217'
...
pbs_submission_infos = dict(
  ...
  ''',
    ...
    other_options=dict(
        ...
        threshold=1.0,
        bic_K=5,
        session_id='cmaes_hier_3_Mratiosigmaxlapsesigmabase_gorgo11',
