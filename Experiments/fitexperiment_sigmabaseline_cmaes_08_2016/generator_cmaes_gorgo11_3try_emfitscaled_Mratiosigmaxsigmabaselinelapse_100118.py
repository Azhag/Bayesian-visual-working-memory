...
run_label = 'cmaes_gorgo11_3try_emfitscaled_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_100118'
...
pbs_submission_infos = dict(
    description=
    '''Fit experiments (gorgo11), using dist_emfit_scaled ResultComputation), using the CMA-ES code. Now with sigma_baseline instead of sigma_output. Using new fixed Covariance matrix for Sampler, should change N=1 case most.
  ...
  ''',
    ...
    other_options=dict(
        ...
        bic_K=5,
        ratio_conj=0.5,
        session_id='cmaes_3try_Mratiosigmaxlapsesigmabase_gorgo11',
