...
run_label = 'cmaes_hier_bays09_2try_llmedian_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_211217'
...
pbs_submission_infos = dict(
  ...
  ''',
    ...
    other_options=dict(
        ...
        threshold=1.0,
        bic_K=5,
        session_id='cmaes_hier_2_Mratiosigmaxlapsesigmabase_bays09',
