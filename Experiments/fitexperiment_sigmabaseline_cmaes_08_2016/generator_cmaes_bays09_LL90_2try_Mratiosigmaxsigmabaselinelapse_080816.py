...
run_label = 'cmaes_bays09_ll90_2try_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_080816'
...
sigmabaseline_range = dict(sampling_type='uniform', low=0.01, high=0.8, dtype=float)
...
dict_parameters_range = dict(M=M_range, lapse_rate=lapserate_range, ratio_conj=ratioconj_range, sigmax=sigmax_range, sigma_baseline=sigmabaseline_range)
# ============================================================================
        ...
        if parameters.get('submit_best', False):
            ...
            try:
                ...
                pbs_submission_infos_copy['other_options'].update(dict(
                    ...
                    stimuli_generation='random',
                    stimuli_generation_recall='random',
                    session_id='cmaes_bays09_2try_rerun_080816',
                    result_computation='filenameoutput',
                    label='%s_cmaes_bays09_2try_080816' % (curr_params_label)
                ))
