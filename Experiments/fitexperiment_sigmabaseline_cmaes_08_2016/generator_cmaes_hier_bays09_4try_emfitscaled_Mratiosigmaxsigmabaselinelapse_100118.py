...
run_label = 'cmaes_hier_bays09_4try_emfitscaled_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_110118'
...
pbs_submission_infos = dict(
    ...
    other_options=dict(
        ...
        threshold=1.0,
        bic_K=5,
        session_id='cmaes_hier_4_Mratiosigmaxlapsesigmabase_bays09',
