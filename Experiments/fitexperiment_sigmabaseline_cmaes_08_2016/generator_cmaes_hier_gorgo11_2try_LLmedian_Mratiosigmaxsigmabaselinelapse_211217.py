...
run_label = 'cmaes_hier_gorgo11_2try_llmedian_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_211217'
...
pbs_submission_infos = dict(
    description=
    '''Fit experiments (gorgo11), using dist_ll_median_allt ResultComputation), using the CMA-ES code. Now with sigma_baseline instead of sigma_output.
  ...
  ''',
    ...
    other_options=dict(
        ...
        threshold=1.0,
        bic_K=5,
        session_id='cmaes_hier_2_Mratiosigmaxlapsesigmabase_gorgo11',
