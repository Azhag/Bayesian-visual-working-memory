...
run_label = 'cmaes_bays09_10try_ll_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_030118'
...
pbs_submission_infos = dict(
    ...
    Trying full LL again to check if parameters were the issue.''',
    ...
    other_options=dict(
        ...
        bic_K=5,
        ratio_conj=0.5,
        session_id='cmaes_10try_Mratiosigmaxlapsesigmabase_bays09',
