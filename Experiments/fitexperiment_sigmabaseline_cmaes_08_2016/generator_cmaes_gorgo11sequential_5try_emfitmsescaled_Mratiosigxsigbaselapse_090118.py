...
run_label = 'cmaes_gorgo11sequential_5try_emfitmsescaled_Mratiosigxsigbaselapsealpha_rep{num_repetitions}_090118'
...
pbs_submission_infos = dict(
    ...
    other_options=dict(
        ...
        bic_K=5,
        ratio_conj=0.5,
        session_id='cmaes_5try_Mratiosigxlrsigbase_gorgo11seq',
