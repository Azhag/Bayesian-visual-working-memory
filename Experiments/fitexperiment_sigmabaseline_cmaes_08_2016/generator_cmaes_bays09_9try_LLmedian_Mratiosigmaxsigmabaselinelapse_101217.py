...
run_label = 'cmaes_bays09_9try_llmedian_Mratiosigmaxsigmabaselinelapserate_repetitions{num_repetitions}_101217'
...
pbs_submission_infos = dict(
    ...
    other_options=dict(
        ...
        bic_K=5,
        ratio_conj=0.5,
        session_id='cmaes_9try_Mratiosigmaxlapsesigmabase_bays09',
