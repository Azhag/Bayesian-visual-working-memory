...
dataset_infos = dict(label='Sweep for receptive field size effect. Change M and rc_scale here. Compute Fisher info, EM Fits and a few other stuff, to be used in parameter sensibility plots for Thesis.',
