...
dataset_infos = dict(
    ...
    variables_to_load=[
        'result_all_precisions', 'result_FI_rc_curv', 'result_FI_rc_theo',
        'result_FI_rc_theocov', 'result_FI_rc_theo_circulant',
        'result_FI_rc_theo_largeN', 'result_marginal_inv_FI',
        'result_marginal_FI', 'result_em_fits'
    ],
    post_processing=None,
    save_output_filename='mratio_rnd')
