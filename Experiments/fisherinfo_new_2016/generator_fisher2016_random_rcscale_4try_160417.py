...
run_label = 'fisher2016_random_rcscale_4try_repetitions{num_repetitions}_160417'
sleeping_period = dict(min=10, max=30)

pbs_submission_infos = dict(description='Better sweep to get receptive field widht effect',
