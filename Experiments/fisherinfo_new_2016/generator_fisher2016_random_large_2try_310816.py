...
run_label = 'fisher2016_random_large_2try_repetitions{num_repetitions}_310816'
sleeping_period = dict(min=20, max=50)

pbs_submission_infos = dict(description='Large random sweep of all parameters. Will compute Fisher info, EM Fits and a few other stuff, to be used in parameter sensibility plots for Thesis. Fixing sigmax and sigma_baseline here.',
