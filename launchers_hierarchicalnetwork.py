...
def launcher_do_hierarchical_precision_M_Mlower(args):
    ...
    # variables_to_save = ['M_space', 'T_space', 'M_lower_space', 'repet_i', 'num_repetitions', 'results_precision_N', 'all_responses', 'all_targets', 'all_nontargets']
    variables_to_save = ['M_space', 'T_space', 'M_lower_space', 'repet_i', 'num_repetitions', 'results_precision_N']
