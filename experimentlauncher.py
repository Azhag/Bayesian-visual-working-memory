...
class ExperimentLauncher(object):
    ...
    def create_argument_parser(self):
        ...
        parser.add_argument('--stimuli_generation', choices=['constant', 'random', 'random_smallrange', 'constant_separated', 'separated'], default='random', help='How to generate the dataset.')
        parser.add_argument('--stimuli_generation_recall', choices=['constant', 'random', 'random_smallrange', 'constant_separated', 'separated'], default='random', help='Dataset generation used for the recall model.')
        ...
        parser.add_argument('--autoset_parameters', dest='autoset_parameters', action='store_true', default=False, help='Automatically attempt to set the rc_scale/ratio to cover the space evenly, depending on the number of neurons')
        ...
        parser.add_argument('--output_both_layers', dest='output_both_layers', action='store_true', default=False, help='Allow both layers of hierarchical network to be read')
        ...
        parser.add_argument('--enforce_first_stimulus', dest='enforce_first_stimulus', action='store_true', default=False, help='Force some datapoints to known values.')
        parser.add_argument('--no-enforce_first_stimulus', dest='enforce_first_stimulus', action='store_false', help='Disable forcing to some datapoints to known values.')
