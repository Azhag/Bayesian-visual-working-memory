...
class ExperimentLauncher(object):
    ...
    def create_argument_parser(self):
        ...
        parser.add_argument('--rcscale_auto', action='store_true', default=False, help='Automatically attempt to set the rc_scale to cover the space evenly, depending on the number of neurons')
        parser.add_argument('--rcscale2_auto', action='store_true', default=False, help='Automatically attempt to set the rc_scale2 (of the second population) to cover the space evenly, depending on the number of neurons')
